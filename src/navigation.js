...
export const footerData = {
  ...
  footNote: `
    ...
    Powered by <a class="text-blue-900 hover:text-blue-600 hover:underline dark:text-muted" href="https://rightruddermarketing.com/"> More Right Rudder</a> · All rights reserved · 
  `,
  locations: [
    {
      city: "Southport, NC",
